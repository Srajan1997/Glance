...
<a title="Write Blogs" href="feedform2.php"><img src="ico1.png" width="32px" height="auto" class="ico3"></a> 
	...
	<br>	<center>Your<br> Blog is ready!</center>
	<br>
					<center style="font-size: 24px; color: black;">Your blog is now available at <a href="blogglance.php" style="color:white; text-decoration: none;">Glance View!</a></center>
		</form></div></center>
